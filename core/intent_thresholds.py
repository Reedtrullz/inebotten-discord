...
CONFIDENCE_THRESHOLDS = {
    ...
    BotIntent.CALENDAR_SEARCH: 0.90,
    BotIntent.REMINDER_EDIT: 0.98,
    BotIntent.REMINDER_DELETE: 0.98,
    BotIntent.REMINDER_SEARCH: 0.90,
    BotIntent.REMINDER_CREATE: 0.90,
    BotIntent.REMINDER_LIST: 0.90,
    BotIntent.REMINDER_COMPLETE: 0.90,
