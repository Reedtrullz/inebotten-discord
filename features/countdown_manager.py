...
class CountdownManager:
    ...
    def __init__(self):
        ...
        self.important_dates = {
            # Norwegian names
            "17. mai": (2026, 5, 17),
            "grunnlovsdagen": (2026, 5, 17),
            "jul": (2026, 12, 25),
            "julaften": (2026, 12, 24),
            "nyttår": (2026, 1, 1),
            "nyttårsaften": (2025, 12, 31),
            "påske": (2026, 4, 5),
            ...
            "valentines": (2026, 2, 14),
            "valentinsdagen": (2026, 2, 14),
            "morsdag": (2026, 2, 8),
            "farsdag": (2025, 11, 9),
            "sankthans": (2025, 6, 23),
            # English names
            ...
            "easter": (2026, 4, 5),
            "summer holiday": (2026, 6, 20),
            "summer vacation": (2026, 6, 20),
            "winter holiday": (2026, 2, 23),
            "autumn holiday": (2025, 10, 6),
            "fall break": (2025, 10, 6),
    ...
    def _find_date(self, query):
        ...
        if date_match:
            ...
            try:
                ...
                print(f"[FEATURES] Countdown parse error: {e}")
